...
/**
 * A factory for creating ShiftScaleBicluster objects.
 */
public class ShiftScaleBiclusterFactory extends AbstractBiclusterFactory{
	...
	/**
	 * Instantiates a new shift scale bicluster factory.
	 *
	 * @param biclusterdatadistributionfactory the biclusterdatadistributionfactory
	 */
	public ShiftScaleBiclusterFactory(ISyntheticDataDistributionFactory biclusterdatadistributionfactory){
	 ...
	 *
	 * @param bicshiftmeanvalue the bicshiftmeanvalue
	 * @return the shift scale bicluster factory
	 */
	public ShiftScaleBiclusterFactory setShiftMeanValue(double bicshiftmeanvalue) {
		this.bicshiftmeanvalue = bicshiftmeanvalue;
		return this;
	}
	 ...
	 * @return the shift scale bicluster factory
	 */
	public ShiftScaleBiclusterFactory setShiftSDValue(double bicshiftsdvalue) {
		this.bicshiftsdvalue = bicshiftsdvalue;
		return this;
	}
	 ...
	 * @return the shift scale bicluster factory
	 */
	public ShiftScaleBiclusterFactory setColMeanValue(double biccolmeanvalue) {
		this.biccolmeanvalue = biccolmeanvalue;
		return this;
	}
	 ...
	 * @return the shift scale bicluster factory
	 */
	public ShiftScaleBiclusterFactory setColSDValue(double biccolsdvalue) {
		this.biccolsdvalue = biccolsdvalue;
		return this;
	}
	 ...
	 * @return the shift scale bicluster factory
	 */
	public ShiftScaleBiclusterFactory setScaleMeanValue(double bicscalemeanvalue) {
		this.bicscalemeanvalue = bicscalemeanvalue;
		return this;
	}
	 ...
	 * @return the shift scale bicluster factory
	 */
	public ShiftScaleBiclusterFactory setScaleSDValue(double bicscalesdvalue) {
		this.bicscalesdvalue = bicscalesdvalue;
		return this;
	}
	...
	public TypeBicluster getTypeOfBicluster() {
		return TypeBicluster.SHIFTSCALE;
	}
	...
	public ArrayList<INDArray> buildBiclusterSetWithBothDimOverlap(int datanumberrows, int datanumbercolumns,
     ...
     public static void main(String[] args) {
    	 ...
    	 ShiftScaleBiclusterFactory factory=new ShiftScaleBiclusterFactory(biclusterdatadistributionfactory);
